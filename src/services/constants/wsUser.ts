...
export const WS_CONNECTION_STOP_USER: 'WS_CONNECTION_STOP_USER' =
  'WS_CONNECTION_STOP_USER'
export const WS_SEND_ORDER_USER: 'WS_SEND_ORDER_USER' = 'WS_SEND_ORDER_USER'
...
export const WS_GET_ORDER_USER: 'WS_GET_ORDER_USER' = 'WS_GET_ORDER_USER'
